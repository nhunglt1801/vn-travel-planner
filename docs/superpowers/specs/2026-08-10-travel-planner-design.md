...
- **Lỗi `/api/suggest` hoặc `/api/itinerary`:** banner nhẹ trong đúng khu vực đó — "Không tạo được gợi ý lúc này, thử lại nhé" + nút **Thử lại**; phần còn lại của UI vẫn dùng được.
